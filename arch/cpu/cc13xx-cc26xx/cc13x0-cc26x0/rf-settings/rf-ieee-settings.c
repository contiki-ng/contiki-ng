...
// This is included from the local driverlib/ directory
#include "driverlib/rf_ieee_cmd.h"
// This is included from the local rf_patches/ directory
#include "rf_patches/rf_patch_cpe_ieee.h"

#include "rf-ieee-settings.h"
/*---------------------------------------------------------------------------*/
// TX Power table
...
const size_t txPowerTableLen = sizeof(txPowerTable) / sizeof(txPowerTable[0]);
