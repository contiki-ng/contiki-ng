...
<simconf>
  ...
  <simulation>
    ...
    <motetype>
      ...
      make -j 6lr.cooja TARGET=cooja MAKE_ROUTING=MAKE_ROUTING_RPL_LITE MAKE_MAC=MAKE_MAC_TSCH MAKE_WITH_ORCHESTRA=1</commands>
    ...
    <motetype>
      ...
      <source>[CONTIKI_DIR]/examples/standalone-native-rpl-border-router/6lr/6lr.c</source>
      <commands>make TARGET=cooja clean
make -j hello-world.cooja TARGET=cooja MAKE_ROUTING=MAKE_ROUTING_RPL_LITE MAKE_MAC=MAKE_MAC_TSCH MAKE_WITH_ORCHESTRA=1</commands>
      <moteinterface>org.contikios.cooja.interfaces.Position</moteinterface>
      <moteinterface>org.contikios.cooja.interfaces.Battery</moteinterface>
      <moteinterface>org.contikios.cooja.contikimote.interfaces.ContikiVib</moteinterface>
      <moteinterface>org.contikios.cooja.contikimote.interfaces.ContikiMoteID</moteinterface>
