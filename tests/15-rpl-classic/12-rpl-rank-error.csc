...
<simconf version="2022112801">
  <simulation>
    ...
    <motetype>
      ...
      make -j$(CPUS) simple-node.cooja TARGET=cooja DEFINES=SIMPLE_CONF_TX_COUNT_MAX=48,SIMPLE_CONF_NODE_TX_ID=2,SIMPLE_CONF_NODE_RX_ID=4</commands>
  ...
  <plugin>
    ...
    <plugin_config>
      <positions>[CONFIG_DIR]/js/12-rpl-rank-error-mobility.dat</positions>
    </plugin_config>
  ...
  <plugin>
    ...
    <plugin_config>
      <scriptfile>[CONFIG_DIR]/js/12-rpl-rank-error.js</scriptfile>
      <active>true</active>
    </plugin_config>
