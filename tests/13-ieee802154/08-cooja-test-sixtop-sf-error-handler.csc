...
<simconf version="2022112801">
  <simulation>
    ...
    <motetype>
      ...
      <source>[CONFIG_DIR]/code-6tisch/test-sixtop-sf-error-handler.c</source>
      <commands>$(MAKE) clean TARGET=cooja
      $(MAKE) -j$(CPUS) test-sixtop-sf-error-handler.cooja TARGET=cooja</commands>
      ...
      <mote>
        <interface_config>
          ...
          <pos x="47.60131881808453" y="20.028921031789082" />
        </interface_config>
        <interface_config>
  ...
  <plugin>
    ...
    <bounds x="0" y="957" height="166" width="1720" z="3" />
  </plugin>
  <plugin>
  ...
  <plugin>
    ...
    <bounds x="290" y="422" height="300" width="500" z="1" />
  </plugin>
  <plugin>
