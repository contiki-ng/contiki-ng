...
make -j$(CPUS) border-router.sky TARGET=sky</commands>
      ...
      <mote>
        <interface_config>
          ...
          <pos x="-24.750327773354453" y="17.688901393447438" />
        </interface_config>
        <interface_config>
...
make -j$(CPUS) hello-world.sky TARGET=sky</commands>
      ...
      <mote>
        <interface_config>
          org.contikios.cooja.interfaces.Position
          <pos x="1.091493067677618" y="40.943504236660225" />
        </interface_config>
        <interface_config>
          org.contikios.cooja.mspmote.interfaces.MspMoteID
          <id>2</id>
      ...
      <mote>
        <interface_config>
          org.contikios.cooja.interfaces.Position
          <pos x="22.647678967805337" y="61.6365018442491" />
        </interface_config>
        <interface_config>
          org.contikios.cooja.mspmote.interfaces.MspMoteID
          <id>3</id>
      ...
      <mote>
        <interface_config>
          org.contikios.cooja.interfaces.Position
          <pos x="44.02005813888037" y="93.02398317771755" />
        </interface_config>
        <interface_config>
          org.contikios.cooja.mspmote.interfaces.MspMoteID
          <id>4</id>
  ...
  <plugin>
    ...
    <bounds x="0" y="742" height="166" width="1804" z="3" />
  </plugin>
  <plugin>
  ...
  <plugin>
    ...
    <bounds x="30" y="403" height="116" width="362" z="1" />
  </plugin>
  <plugin>
...
while (true) { YIELD(); }</script>
    ...
    <bounds x="850" y="13" height="700" width="600" />
  </plugin>
</simconf>
