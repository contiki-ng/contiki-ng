...
$(MAKE) -j$(CPUS) node.cooja TARGET=cooja MAKE_WITH_ORCHESTRA=1 MAKE_WITH_SECURITY=0 MAKE_WITH_PERIODIC_ROUTES_PRINT=1 MAKE_WITH_ORCHESTRA_ROOT_RULE=1</commands>
 ...
 * 9 routing links including one for the root (i.e. can reach every node)&#xD;
...
while(true) {;&#xD;
  WAIT_UNTIL(msg.contains("Routing links") || msg.contains("use the root rule"));&#xD;
  log.log(msg + "\n");&#xD;
  if(uses_root_rule &amp;&amp; msg.contains("Routing links: 9")) {&#xD;
